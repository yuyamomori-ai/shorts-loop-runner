...
export function initialState() { return {version:SCHEMA_VERSION,settings:{mode:'review',paused:true,dailyLimit:3,adaptivePace:true,minSpacing:45,times:['12:00','18:00','21:00'],timezone:'Asia/Tokyo',privacy:'private',madeForKids:false,derivedApproved:false,publicApproved:false,dailyAiCalls:60},live:emptyData(),demo:emptyData()}; }
...
export function digestable(v) { return JSON.stringify([v.title,v.description,v.privacy,v.madeForKids,v.containsSyntheticMedia,v.tags,v.publishAt,v.segments,v.videoHash,v.revision]); }
