...
export function requestPublicAutopilot(state,requestId,{repairVideoId}={}) {
  ...
  if(a.phase!=='attention'||billing||editable||repair&&productionStop){Object.assign(a,{userPaused:false,phase:'waiting',reason:null});state.settings.paused=true;delete a.retryAt;}
  return true;
}
