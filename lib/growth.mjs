...
const VISUAL_DIMENSIONS=['sceneCount','averageSceneDuration','realFootageRatio','diagramCount','scienceCardCount','zoomCount','replayCount','highlightCount','calloutCount','hookVisualType','captionDensity','visualStyle'];
function visualDimension(v,key){
 ...
 if(key==='realFootageRatio')return x<.25?'low':x<.6?'balanced':'high';
...
export function enrichStrategy(data,settings,isDemo=false){
 ...
 const allocations=[];
 for(const dimension of ['contentType','genre','captionStyle','narrationSpeed','editingStyle','weekday','sceneSeconds','visualStyle','hookVisualType','sceneCount','averageSceneDuration','realFootageRatio','diagramCount','scienceCardCount','zoomCount','replayCount','highlightCount','calloutCount','captionDensity']){
