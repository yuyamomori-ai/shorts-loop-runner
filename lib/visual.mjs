...
export const CREATIVE_BRIEF = `Use a short, intriguing Japanese headline suitable for large red text with a white outline. No clickbait unsupported by the answer. Include at most one or two short original spoken reactions or gentle tsukkomi when they fit, followed immediately by clear explanation. The reaction must appear in text to be narrated; callout alone is not spoken. Treat humor as a reaction, never a new factual claim, invented anecdote or ridicule of participants. Learn general pacing, question-to-payoff structure and contrast from references; never copy a creator's lines, distinctive jokes, branding, voice or footage. Keep the final payoff tied to the opening question.`;
