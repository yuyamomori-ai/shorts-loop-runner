...
export class Engine {
 ...
 async reviewOriginality(v,result,asset){
  ...
  const musicContext=result.manifest.musicEvidence?.mode==='original'?'実際のBGMはこのシステムで合成した自作曲で、第三者の録音・サンプルは含まない。音源の証拠はmanifest.musicEvidenceを確認。':'曲名は未添付の候補で、音源追加待ちは別の公開ゲートで停止する。';
